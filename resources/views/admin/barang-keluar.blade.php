...
<div class="d-flex justify-content-center">
    <form action="/admin/barang-keluar{{ $id_distribusi_barang?'/'.id_distribusi_barang:'' }}" method="POST" class="w-75">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input type="number" class="form-control" id="jumlahBarang" name="jumlah_barang" placeholder="Jumlah Barang Keluar" required value="@if($distribusiBarang !=null){{ old('jumlah_barang', $distribusiBarang->jumlah_barang) }}@endif">
            </div>
        </div>
        <div class="row mb-3">
            <label for="tanggalKeluar" class="col-sm-2 col-form-label">Tanggal Keluar</label>
            <div class="col-sm-10">
                <input type="date" class="form-control" id="tanggalKeluar" name="tanggal" placeholder="Tanggal Keluar" required value="@if($distribusiBarang !=null){{ old('tanggal', $distribusiBarang->tanggal) }}@endif">
            </div>
        </div>
        <div class="row">
